...
_init_draw_count): draws whose chemistry does not converge within count_max are
REJECTED (not carried, not raised on), and the init OVERSAMPLES so the culled cloud
still holds exactly N healthy particles.
